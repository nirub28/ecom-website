   ...
   const len = cart.length;
    ...
    return (
      <div className={styles.nav}>
       ...
       <span className={styles.appName}><a className={`${styles.appLink} ${styles.prodLink}`} href='/'>eCommerce</a></span> 
       ...
       <div className={styles.cartIconContainer}><a href='/cart'><img className={styles.cart} src='https://cdn-icons-png.flaticon.com/512/3737/3737372.png' alt='cart-icon' /></a> <sup className={styles.cartCount}>{len}</sup></div>
