   ...
   const len = cart.length;
    ...
    return (
      <div className={styles.nav}>
       ...
       <div className={styles.cartIconContainer}><a href='/cart'><img className={styles.cart} src='https://cdn-icons-png.flaticon.com/512/833/833314.png' alt='cart-icon' /></a> <sup className={styles.cartCount}>{len}</sup></div>
